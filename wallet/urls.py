...
urlpatterns = [
    ...
    path('merchants/banks', merchant_views.merchant_banks, name='merchant_banks'),
    path('merchants/me/bank-accounts', merchant_views.merchant_session_bank_accounts, name='merchant_session_bank_accounts'),
    path('merchants/me/withdrawals', merchant_views.merchant_session_withdrawals, name='merchant_session_withdrawals'),
