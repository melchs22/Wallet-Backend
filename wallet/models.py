...
class Transaction(models.Model):
    ...
    merchant_fee_amount = models.DecimalField(max_digits=20, decimal_places=2, default=Decimal('0.00'))
...
class Merchant(models.Model):
    ...
    merchant_code = models.CharField(max_length=6, unique=True, blank=True, null=True, db_index=True)
